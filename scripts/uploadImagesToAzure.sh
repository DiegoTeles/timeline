...
AZURE_STORAGE_ACCOUNT='dttimeline'
RESOURCE_GROUP='diegotelles'
container_name='timeline-telles'
source_folder='../'
...
# az storage blob delete-batch --pattern 2019-06-29-10_secrets_to_improve_javascript_performance -s timeline-diegoteles
